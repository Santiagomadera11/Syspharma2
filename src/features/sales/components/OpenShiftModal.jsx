...
/**
 * Modal obligatorio para abrir turno/caja
...
export const OpenShiftModal = ({ isOpen, onShiftOpened, user, canClose = false, onCancel = null }) => {
  ...
  const handleOpenShift = async (e) => {
    ...
    // Validaciones
    if (!montoBase || montoBase === "") {
      setError("El monto base es obligatorio");
      return;
    }
    ...
    try {
      ...
      // Abre el turno
      const newTurn = turnService.openTurn(userData, amount);
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 border border-gray-200 relative">
          ...
          <form onSubmit={handleOpenShift} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1.5">
                Ingresa el dinero inicial para dar vueltas
              </p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3.5 flex gap-2">
              ...
              <p className="text-xs text-blue-800">
                <strong>Nota:</strong> No podrás realizar ventas o gastos sin
                tener un turno activo.
              </p>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-2.5 rounded-lg font-bold text-white transition-all duration-200 ${
                loading
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <p className="text-xs text-gray-500 text-center">
              📌 Este modal es obligatorio para iniciar el día
            </p>
          </div>
        </div>
      </div>
