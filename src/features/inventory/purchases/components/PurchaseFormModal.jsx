...
const PurchaseModal = ({
  ...
  const focusBorderColor = isEmployee
  ...
  const handleFinalizePurchase = () => {
    ...
    setConfirmationMessage(
      "✅ Compra registrada con éxito y stock actualizado",
    );
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200 overflow-y-auto">
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-[90vw] md:max-w-3xl lg:max-w-4xl flex flex-col max-h-[90vh] overflow-y-auto">
        ...
        {/* Header */}
        <div
          className={`${headerBgColor} px-4 py-3 border-b ${headerBorderColor} flex justify-between items-center flex-shrink-0`}
        >
        ...
        <div className="p-4 flex-1 pb-6">
          {isView ? (
            ...
            <>
              ...
              {/* Items Table */}
              <div className="mb-8">
                <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 pb-2 border-b border-gray-200">
                  Productos
                </h4>
                <table className="w-full text-sm">
                  <thead className="border-b border-gray-300">
                    <tr>
                      <th className="text-left px-2 py-2 text-xs font-bold text-gray-700">
                        Producto
                      </th>
                      <th className="text-center px-2 py-2 text-xs font-bold text-gray-700">
                        Cant
                      </th>
                      <th className="text-center px-2 py-2 text-xs font-bold text-gray-700">
                        Lote
                      ...
                      <th className="text-right px-2 py-2 text-xs font-bold text-gray-700">
                        Costo Unit.
                      </th>
                      <th className="text-right px-2 py-2 text-xs font-bold text-gray-700">
                        Subtotal
              ...
              <div className="flex justify-end mb-6">
                <div
                  className={`${headerBgColor} border-2 ${headerBorderColor} rounded-lg px-8 py-4`}
                >
                  ...
                  <p className={`text-3xl font-bold ${confirmIconColor}`}>
                    $
                    {Number(formData.total || 0).toLocaleString(undefined, {
                      maximumFractionDigits: 2,
                    })}
                  </p>
                </div>
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {purchaseItems.length > 0 ? (
                      ...
                      <tr>
                        <td
                          colSpan={7}
                          className="px-4 py-6 text-center text-xs text-gray-400 italic bg-gray-50/30"
                        >
                  ...
                  <tfoot className="bg-gray-50 border-t border-gray-200">
                    <tr>
                      ...
                      <td
                        className={`px-4 py-3 text-right text-sm font-bold ${confirmIconColor}`}
                      >
                        ${" "}
                        {(formData.total || 0).toLocaleString(undefined, {
                          maximumFractionDigits: 2,
                        })}
                      </td>
                      <td></td>
        ...
        {/* Footer */}
        <div
          className={`${headerBgColor} border-t ${headerBorderColor} p-4 flex-shrink-0 flex gap-3`}
        >
          {isView ? (
            <button
              onClick={onClose}
            ...
            >
              <Save size={16} />{" "}
              {mode === "edit" ? "Guardar" : "Finalizar Compra"}
            </button>
          )}
        </div>
      </div>
      ...
      {isConfirmationOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-lg shadow-2xl w-full max-w-sm overflow-hidden flex flex-col">
            {/* Header Verde */}
            <div
              className={`${headerBgColor} px-6 py-4 border-b ${headerBorderColor} flex justify-between items-center`}
            >
            ...
            <div className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 text-xs">
                El stock de los productos ha sido actualizado correctamente en
                el inventario.
              </p>
            </div>
            ...
            {/* Footer Verde */}
            <div
              className={`${headerBgColor} border-t ${headerBorderColor} p-4`}
            >
              <button
                onClick={() => setIsConfirmationOpen(false)}
