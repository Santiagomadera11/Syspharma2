          ...
          <div className="p-5 border-t bg-gray-50">
            ...
            {isCheckout ? (
              <button
                ...
                className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-all disabled:opacity-70"
              >
                {isSubmitting ? (
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full py-3 bg-gray-900 hover:bg-gray-800 text-white rounded-xl font-bold shadow-lg transition-all active:scale-95"
                >
                  Continuar Compra
                </button>
                <button
