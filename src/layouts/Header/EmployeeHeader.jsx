...
export const EmployeeHeader = ({ onMenuClick }) => {
  ...
  return (
    <header className="h-14 bg-blue-600 border-b border-blue-700 flex items-center justify-between px-5 shadow-md z-20 text-white flex-shrink-0">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[9px] text-blue-100 uppercase tracking-wider font-medium opacity-80">
              Panel Empleado
            </p>
          </div>
        </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 cursor-pointer group">
          ...
          <div className="w-8 h-8 bg-white text-blue-600 rounded-full flex items-center justify-center font-bold border-2 border-blue-200 shadow-sm text-xs">
